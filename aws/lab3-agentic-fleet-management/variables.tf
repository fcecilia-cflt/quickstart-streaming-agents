...
variable "elasticsearch_endpoint_lab3" {
  description = "Elasticsearch endpoint URL (e.g., https://my-cluster.es.us-east-1.aws.elastic.cloud:443)"
  type        = string
  sensitive   = true
  default     = "https://workshop-cluster.es.us-east-1.aws.elastic-cloud.com:443"
}
